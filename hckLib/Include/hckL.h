...
typedef int  RecivePacketHandler(E_Head EthernetFrame);
...
extern "C"
{
	...
	*/
	...
	__declspec(dllexport) int SetReciveMPHandler(RecivePacketHandler* Recv, Userminiport* MiniP);
	...
	*/
	...
	__declspec(dllexport) int SetSendMPHandler(RecivePacketHandler* Recv, Userminiport* MiniP);
...
*/
	...
	/*
			...
			Funkcja wysy³a surowy pakiet
			Przed wys³aniem pakietu nale¿y wyzerowaæ strukturê Frame
	...
	*/
	...
	__declspec(dllexport) int GetConnected(int* ConnectedCount, Dev_Lan* dev);
